...
<body background="background.jpg">
 <center>
 <h1> Volunteer under Organiser3 </h1>
 </center>
...
<?php
require 'connect.php';
$query="SELECT * FROM volunteer where vol_id in (SELECT vol_id FROM area a WHERE a.area_name in (SELECT area FROM organiser o where o.id='o3'))";
